        ...
        <div class="wrapper">
            <div class="content-full  left">
                ...
                <div class='content-left content-margin left'>
                    ...
                    ?>
                    <form style="text-align:center" method="post" action="http://baselcitykubb.ch/develliga/" >
                            ...
                            for ($spielezaehler = 1; $spielezaehler <= 10; $spielezaehler++){
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-xs">
                                            <?php
                                            echo $letztesspiel[1]." (".$letztesspiel[3].")";
                                            ?>
                                        </td>
                                        <td class="visible-xs">
                                            <?php
                                            echo substr($letztesspiel[1], 0, 7);
                                            if(strlen($letztesspiel[1])>7){
                                                echo "...";
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <?php
                                $ticker .= $letztesspiel[1]." vs. ".$letztesspiel[2]." ".$letztesspiel[5].":".$letztesspiel[6]." | ";
                            }
                            $file = 'ticker.txt';
