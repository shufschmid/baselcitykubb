...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			...
			<div class="nav-links">
				...
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'baselcitykubb' ) ); ?></div>
	...
	if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
		...
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'baselcitykubb' ); ?></p>
	<?php
	endif;
